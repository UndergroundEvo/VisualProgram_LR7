...
namespace GraphicEditor.Models.Shapes
{
    ...
    {
        public static string Stringify(this Geometry geometry)
        {
            if (geometry is not GeometryShake @shake) 
                throw new Exception("Geometry не является предком GeometryShake");
